...
async def check_and_send_reminders(context: ContextTypes.DEFAULT_TYPE):
    """Check and send reminders - called by job_queue"""
...
def main():
    ...
    # Add job for checking reminders every 30 seconds
    job_queue = application.job_queue
    job_queue.run_repeating(check_and_send_reminders, interval=30, first=10)
    
    print("Bot started successfully!")
    print("Commands: /start, /help, /list")
    print("Reminder checker running every 30 seconds...")
